...
`DB` という名前で D1 binding を Worker に追加してください。スキーマと初期データは [db/schema.sql](/home/sora/work/homepage/db/schema.sql:1) と [db/seed.sql](/home/sora/work/homepage/db/seed.sql:1) にあります。
