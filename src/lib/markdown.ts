...
function renderMarpDeckHtml(html: string, css: string) {
  return [
    '<section class="marp-deck" data-marp-deck data-view="presentation" data-active-slide="0" tabindex="0">',
    '  <div class="marp-deck__toolbar">',
    '    <div class="marp-deck__modes" role="group" aria-label="表示モード">',
    '      <button type="button" class="dads-button marp-deck__button marp-deck__icon-button" data-size="md" data-type="outline" data-active="false" data-marp-action="list" aria-label="一覧表示">',
    '        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h7v6H4V5Zm9 0h7v6h-7V5ZM4 13h7v6H4v-6Zm9 0h7v6h-7v-6Z" fill="currentColor"></path></svg>',
    "      </button>",
    '      <button type="button" class="dads-button marp-deck__button marp-deck__icon-button" data-size="md" data-type="solid-fill" data-active="true" data-marp-action="presentation" aria-label="プレゼン表示">',
    '        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h16v11H4V5Zm1.5 1.5v8h13v-8h-13Zm4.5 11h4v1.5h3V21H7v-2h3v-1.5Z" fill="currentColor"></path></svg>',
    "      </button>",
    "    </div>",
    ...
    "      </button>",
    '      <button type="button" class="dads-button marp-deck__button marp-deck__icon-button" data-size="md" data-type="outline" data-marp-action="fullscreen" aria-label="全画面">',
